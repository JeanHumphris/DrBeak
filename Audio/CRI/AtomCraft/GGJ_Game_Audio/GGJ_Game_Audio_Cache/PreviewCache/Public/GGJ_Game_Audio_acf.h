...
#define CRI_GGJ_GAME_AUDIO_ACF_CATEGORYNUM (1)
#define CRI_GGJ_GAME_AUDIO_ACF_AISACCONTROLNUM (16)
#define CRI_GGJ_GAME_AUDIO_ACF_GLOBALAISACNUM (0)
...
#define CRI_GGJ_GAME_AUDIO_ACF_DSPBUSNAMENUM (1)
#define CRI_GGJ_GAME_AUDIO_ACF_GAMEVARIABLENUM (1)
#define CRI_GGJ_GAME_AUDIO_ACF_SELECTORNUM (0)
#define CRI_GGJ_GAME_AUDIO_ACF_REACTNUM (0)
#define CRI_GGJ_GAME_AUDIO_ACF_OUTPUTPORTNUM (0)

/* Category List (Category ID) */
#define CRI_GGJ_GAME_AUDIO_ACF_CATEGORY_CATEGORY_0           ( 0) /*  */

/* AISAC Control List (AISAC Control ID) */
#define CRI_GGJ_GAME_AUDIO_ACF_AISACCONTROL_AISACCONTROL_00      ( 0) /*  */
